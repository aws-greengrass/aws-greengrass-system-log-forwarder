...
/// @param[out] buffer The 17 character long user provided buffer in which
...
/// @param[out] The vector in which the key:value pair is encoded.
...
/// @param[out] auth_header is the buffer which should be long enough to
